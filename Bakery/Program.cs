  ...
  public class Program
  {
    public static void Main()
    {
      ...
      switch (userDecision)
      {
        ...
        default:
          Console.WriteLine("What??? I don't know what you're saying. We only deal in Y or N for this answer. Come back another day when you learn to follow directions...");
          break;
      }
    }
  }
